...
class HermesCLI:
    ...
    def __init__(
        ...
        self._nous_key_expires_at: str | None = None
        self._nous_key_source: str | None = None
    ...
    def _ensure_runtime_credentials(self) -> bool:
        ...
        routing_changed = resolved_provider != self.provider or resolved_api_mode != self.api_mode
    ...
    def _preload_resumed_session(self) -> bool:
        ...
        if not session_meta:
            ...
            self.console.print("[dim]Use a session ID from a previous CLI run (hermes sessions list).[/]")
            return False
        ...
        if restored:
            ...
            self.console.print(f"[#DAA520]Session {self.session_id} found but has no messages. Starting fresh.[/]")
            return False
    ...
    def process_command(self, command: str) -> bool:
        ...
        if cmd_lower in ("/quit", "/exit", "/q"):
            ...
            if len(parts) > 1:
                ...
                from hermes_cli.models import _PROVIDER_LABELS, curated_models_for_provider, normalize_provider
    ...
    def run(self):
        ...
        _normal_input = Condition(lambda: not self._clarify_state and not self._approval_state and not self._sudo_state)
        ...
        def _get_image_bar():
            ...
            badges = " ".join(f"[📎 Image #{base + i}]" for i in range(len(cli_ref._attached_images)))
