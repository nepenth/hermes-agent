...
async def _call_summarizer_llm(
    content: str, context_str: str, model: str, max_tokens: int = 20000, is_chunk: bool = False, chunk_info: str = ""
) -> str | None:
    """
    ...
    async def summarize_chunk(chunk_idx: int, chunk_content: str) -> tuple[int, str | None]:
        ...
        try:
            ...
            summary = await _call_summarizer_llm(
                chunk_content, context_str, model, max_tokens=10000, is_chunk=True, chunk_info=chunk_info
            )
            if summary:
                logger.info(
