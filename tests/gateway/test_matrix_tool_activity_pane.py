...
def test_sanitize_keeps_ol_li_and_matrix_safe_details():
    html = (
    ...
    # Shared sanitizer preserves Matrix-safe details/summary for approval cards.
    # Tool activity HTML itself still must not emit them (producer test above).
