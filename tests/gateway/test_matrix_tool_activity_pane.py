...
def test_sanitize_keeps_ol_li_and_allows_approval_details():
    ...
    # Shared sanitizer keeps Matrix-safe details for approval cards.
    # The Tool activity producer itself must still not emit details.
    assert "<details>" in out
    assert "<summary>" in out
    _body, produced = matrix_tool_activity_bodies(["💻 terminal: ls"])
