...
class WorkspaceRegistry:
    ...
    def resolve_source(self, source: SessionSource) -> Optional[WorkspaceBinding]:
        ...
        workspace_scope = str(source.guild_id) if source.guild_id else None
...
def _channel_matches(
    ...
    configured_scope = channel.get("guild_id") or channel.get("workspace_id") or channel.get("team_id")
